...
class BOT_ANSWERS(str, Enum):
    greeting = "Приветствую! <strong>Я бот</strong> приюта для животных. Готовы ли вы представиться?"
    greeting_partial_data = "<strong>Рады приветствовать вас снова!</strong> <em>Готовы ли вы предоставить</em> дополнительную информацию?"
    ...
    personal_data_consent = "Подтверждение согласия на обработку персональных данных. Ознакомиться с Положением об обработке персональных данных можно по адресу: https://predannoeserdce.ru/wp-content/themes/catheart/img/soglasheniye.pdf"
